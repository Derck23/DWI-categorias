...
public class CategoriaService {
    ...
    public List<Categorias> buscar(boolean soloActivos) {
        // Como ya no tenemos campo activo, simplemente devolvemos todas las categorías
        return repo.findAll();
    }
    ...
    public Optional <Categorias> editar(int id, Categorias categoria) {
        ...
        if (opt.isPresent()) {
            ...
            d.setCategoriaFederal(categoria.getCategoriaFederal());
            d.setCategoriaEstatal(categoria.getCategoriaEstatal());
